...
class seq_base(nn_base):
    ...
    def hyper_init(self,):
        ...
        self.hyper.learning_rate = 0.0035524761143657935
...
class Seq2_RL(seq_base):
    ...
    def hyper_modify(self):  
        ...
        self.hyper.agent_hidden_size = 448
        self.hyper.agent_dropout_rate = 0.6
        self.hyper.agent_lr = 7.668322567200224e-05
        self.hyper.agent_step_gamma = 0.91
