...
class seq_base(nn_base):
    ...
    def hyper_init(self,):
        ...
        self.hyper.encoder_hidden_size = 184
        self.hyper.encoder_num_layer = 1
        self.hyper.decoder_hidden_size = 156
        self.hyper.decoder_num_layer = 2
        self.hyper.decoder_input_size = 88
        self.hyper.learning_rate = 0.005
        self.hyper.step_gamma = 0.9842716742679477
...
class Seq2_RL(seq_base):
    ...
    def hyper_modify(self):  
        ...
        self.hyper.agent_dropout_rate = 0.5
        self.hyper.agent_lr = 0.00030116834380314924
